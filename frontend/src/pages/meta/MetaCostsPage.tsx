        ...
        <div className="p-5 md:p-6">
          <div className="grid gap-4 md:grid-cols-2">
            <section className="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-white/[0.02]">
              ...
              <div className="mt-3 flex h-10 items-center gap-3">
                <span className="flex h-10 w-14 items-center justify-center rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
                  <img
                    src="/flags/br.svg"
                    alt="Bandeira do Brasil"
                    className="h-6 w-9 rounded-[3px] shadow-theme-xs"
                  />
                </span>
                <div>
                  <p className="text-sm font-semibold text-gray-900 dark:text-white">Brasil</p>
                  <p className="mt-0.5 text-xs text-gray-400">Mercado fixo da Meta</p>
                </div>
              </div>
            </section>
            <section className="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-white/[0.02]">
            ...
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Valores iniciais para o Brasil ·{' '}
          ...
          <div className="mt-6">
            ...
            {store.templates.map((item) => (
              <div
                key={item.id}
                className="grid gap-3 border-b border-gray-100 py-4 dark:border-gray-800 md:grid-cols-[1.2fr_1fr_.7fr_1fr] md:items-center"
              >
                ...
                />
                <strong className="text-right text-sm text-gray-800 dark:text-white/90">
            ...
            <div className="mt-4 flex justify-between rounded-lg bg-brand-50 px-4 py-3 text-sm font-semibold text-brand-700 dark:bg-brand-500/10 dark:text-brand-400">
              ...
              <span>{formatCurrency(totals.meta, store.currency)}</span>
            </div>
          </div>
        </div>
      </CalculatorCard>
